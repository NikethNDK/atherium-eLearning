...
//     } catch (err) {
//       setError(err.response?.data?.detail || `Failed to ${block ? "block" : "unblock"} user`);
//     } finally {
//       setLoading(false);
//     }
//   };
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="text-gray-600 px-4 py-2 border border-gray-300 rounded-lg text-sm">🔽 Filter</button>
          </div>
              ...
              <tbody>
                {currentUsers.map((user) => (
                  <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center space-x-2">
                        <button className="text-gray-400 hover:text-blue-600" title="View">👁️</button>
                        <button className="text-gray-400 hover:text-green-600" title="Edit">✏️</button>
                        <button className="text-gray-400 hover:text-red-600" title="Delete">🗑️</button>
                      </div>
                    </td>
                  </tr>
                ))}
