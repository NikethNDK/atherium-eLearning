            ...
            <div className="p-4">
              ...
              <div className="flex items-center mb-2 sm:mb-3 text-xs sm:text-sm text-gray-600">
                <img
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 rounded-full mr-1 sm:mr-2"
                />
                <span>
              ...
              <Link
                to={`/my-learning/${course.id}`}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 sm:px-4 rounded-lg font-medium transition-colors duration-200 block text-center text-xs sm:text-sm"
              >
